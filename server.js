// ============================================================================
// RETROCHAT95 v1.0 - ULTIMATE EDITION - FINAL
// Complete Server with All Bug Fixes and Features
// ============================================================================
...
const TIPS = [
    ...
    "[TIP] Drag windows around the desktop",
    "[TIP] Play games from desktop icons",
        ...
        switch(cmd) {
            ...
            case '/nick':
                ...
                if (!newName || newName.length < 2 || newName.length > 20) {
                    socket.emit('command-error', 'Usage: /nick <n> (2-20 chars)');
                    return;
                }
                if (user.isGuest) {
